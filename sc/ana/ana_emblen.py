...
def test(logger, config):
    ...
    # fake 224/ real 256
    all_paths.append(['emblen-6', '/home1/quanquan/code/landmark/code/runs/ssl/ssl_probmap/collect_sim_debug3/ckpt_v/model_best.pth'])
    all_paths.append(['emblen-4', '/home1/quanquan/code/landmark/code/runs/ssl/ssl_probmap/collect_sim_debug3_2/ckpt_v/model_best.pth'])
    all_paths.append(['emblen-16', '/home1/quanquan/code/landmark/code/runs/ssl/ssl_probmap/collect_sim/ckpt_v/model_best.pth'])
