...
from tutils import trans_args, trans_init, save_script, tfilename, tdir, time_str
...
def main(args, logger, config):
    if args.dataset == "ceph":
        ...
        # test_dataloader = data.DataLoader(Ceph(args.data_path, test=True), drop_last=False, batch_size=args.batch_size)
    ...
    for split in splits:
        ...
        logger.info("# ------------------------------------------------ #")
        csvlogger.record({'current_indices':current_indices, "labeling_indices":sampled_indices, "time_str": time_str(), })
...
if __name__ == '__main__':
    ...
    ids_15 = [5,22,27,34,51,56,63,80,89,108,109,127,136,144,147]
