...
from utils.tester.tester_hand_u2net import Tester
...
def train(logger, config):
    ...
    dataset_train = HandXray(config['dataset']['pth'],
                                  ...
                                  cj_contrast=config_spe['cj_contrast'], num_repeat=5)
