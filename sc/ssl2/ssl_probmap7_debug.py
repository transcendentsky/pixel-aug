...
EX_CONFIG = {
    "dataset":{
        ...
        'prob': '/home1/quanquan/datasets/Cephalometric/prob_point_pseudo2/train/',
...
def train(logger, config):
    ...
    dataset_train = Cephalometric(config['dataset']['pth'], patch_size=config['special']['patch_size'],
                             ...
                             mode="Train", retfunc=2, hard_select=True, multi_output=False, runs_dir=config['base']['runs_dir'])
    # dataset_train.prob_map_point(all_landmarks)
    dataset_train.prob_map_for_all(all_landmarks, sharpness=0.2, kernel_size=config['special']['probmap_ks'], inverse=True)
