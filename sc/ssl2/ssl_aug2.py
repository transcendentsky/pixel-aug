...
EX_CONFIG = {
    ...
    "special": {
        ...
        # "cj_brightness": [0.505, 1.997], # low
        # "cj_contrast": [0.340, 2.329],
        # "cj_brightness": [0.5617, 1.612], # high
        ...
        "adap_params": {
            ...
            "me": {
                "cj_brightness": [0.6, 1.55], #[0.6, 1.6], # [0.55, 1.7],
                "cj_contrast": [0.5, 1.65],# [0.5, 1.7], # [0.4, 2.0],  
                },
            "he": {
                "cj_brightness": [0.65, 1.45], # [0.8, 1.2],
                "cj_contrast": [0.6, 1.55], # [0.8, 1.3],  
                },
        },
        'pretrained_model': "/home1/quanquan/code/landmark/code/runs/ssl/ssl_probmap6/discard_0-2/ckpt_v/model_best.pth"
    },
    "training": {
...
class Learner(LearnerModule):
    ...
    def load(self, pth=None, *args, **kwargs):
        if pth is None:
            ...
            state_dict = torch.load(self.config['special']['pretrained_model'])
