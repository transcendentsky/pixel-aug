...
EX_CONFIG = {
    "dataset":{
        'entr': '/home1/quanquan/datasets/Cephalometric/entr_64/train/',
        'prob': '/home1/quanquan/datasets/Cephalometric/prob_ks1/train/',
        "mi_dir": '/home1/quanquan/code/landmark/code/tproj/tmp_visual/mi',
    },
    "special":{
        "patch_size": 224,
        "prob_ratio": 0,
...
def train(logger, config):
    ...
    dataset_train = Cephalometric(config['dataset']['pth'], patch_size=config['special']['patch_size'],
                             mode="Train", retfunc=2, hard_select=True, multi_output=False)
    # dataset_train.prob_map_point(all_landmarks)
    dataset_train.prob_map_mi(mi_dir=config['dataset']['mi_dir'])
