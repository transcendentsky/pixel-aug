...
class Pelvis(data.Dataset):
    ...
    def __init__(self, prefix, phase, transform_params=dict(), sigma=5, num_landmark=10, size=[512, 512], exclude_list=None, use_background_channel=False):
        ...
        # file index
        files = [i[:-4] for i in sorted(os.listdir(self.pth_Label))]
