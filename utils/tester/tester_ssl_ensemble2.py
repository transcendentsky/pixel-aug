"""
    Ensemble 1:
        Compare: Aug_k(Template) -> Aug_k(Target) ; Aug_k is identical
    Ensemble 2:
        Compare: Aug(Template) -> Target

    This script is using Ensemble 2.
"""
import torch
import numpy as np
...
class Tester(object):
    ...
    def test_func(self, net, epoch=None, rank='cuda', oneshot_id=-1, dump_label=False, draw=False):
        ...
        # img_total = torch.stack([img, img_ac, img_co, img_eq, img_po])
